        ...
        <div className={styles.features}>
            <div className={styles.main}>
                ...
                <div className={styles.cards}>
                    ...
                    <Card className={styles.five} title="Responsive Design for Any Device" description="Enjoy a smooth experience on any device with our app’s responsive design." image="Expensrol_image\businessmen-climb-up-the-ladder-pie-chart-with-no-space-left-for-women-illustration-download-in-svg-png-gif-file-formats--path-logo-gender-gap-salary-business-project-pack-illustrations-7202303 1.svg" />
                    <Card className={styles.six} title="Local Storage for Data Persistence" description="Your data is saved automatically, so it’s always there when you return." image="Expensrol_image\7407585 1.svg" />
                </div>
            </div>
        </div>
